<H1 align="center"><a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=2dc653&width=435&lines=Hola!!+I'm+Shrishti+Tiwari;I'm+a+Data+Scientist;And+Full+Stack+Web+Developer" alt="Typing SVG" /></a></H1>
...
- Mathematics ✍️: Vector Space, Linear Algebra, Probability, Statistical models, Determinant, Matrices
- Python 👩‍💻: Data Structure and Algorithm, Problem Solving, Pandas, NumPy, Matplotlib, Seaborn
- SQL 👩‍💻: Database Management, Building Queries, Problem Solving
- Data Visualization 📊: Power BI, Tableau, Matplotlib and Seaborn
- Machine Learning Models 🔎: Linear Regression, Logistic Regression, XG Boost, Reinforce Algorithm such as Decision tree and Random Forest Algorithm, Support Vector Machine, K cross-fold Algorithm, Adaboost
- NLP: TF-idf, Tokenization, Stemmer, Lemetizer, Removal of Stop Words
